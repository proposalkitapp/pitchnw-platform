...
const templates = [
  { name: "Clean Minimalist", category: "Web Design", price: "$9", rating: 4.9, purchases: 342 },
  { name: "Bold Agency", category: "Branding", price: "$15", rating: 4.8, purchases: 218 },
  { name: "Tech Startup", category: "Mobile App", price: "Free", rating: 4.7, purchases: 891 },
  { name: "Creative Portfolio", category: "Photography", price: "$7", rating: 4.9, purchases: 156 },
  { name: "SEO Powerhouse", category: "Digital Marketing", price: "$12", rating: 4.6, purchases: 305 },
  { name: "E-commerce Pro", category: "E-commerce", price: "$19", rating: 4.8, purchases: 127 },
];
      ...
      <div className="container mx-auto px-4">
        <FadeInView className="text-center mb-16">
          ...
          <p className="text-muted-foreground text-lg max-w-xl mx-auto">
            Browse premium templates built by top-earning freelancers. Or build and sell your own.
          </p>
        </FadeInView>
                ...
                <div className="p-5">
                  ...
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    ...
                    <div className="flex items-center gap-1">
                      ...
                      <span>{template.purchases} uses</span>
                    </div>
                  </div>
                </div>
              </motion.div>
